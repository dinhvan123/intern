                            ...
                            {if $user->_logged_in}
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        {/if}
                                        {if ($user->_data['user_group'] < 3 || $system['pages_enabled']) || ($user->_data['user_group'] < 3 || $system['groups_enabled']) || ($user->_data['user_group'] < 3 || $system['events_enabled'])}
                                            <li class="divider"></li>
                                            ...
                                            {if $user->_data['user_group'] < 3 || $system['events_enabled']}
                                                <li>
                                                    <a href="{$system['system_url']}/events/manage">{__("Manage Events")}</a>
                                                </li>
                                            {/if}
                                        {/if}
                                        <li class="divider"></li>

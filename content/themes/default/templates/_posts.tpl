	    ...
	    <div class="pull-right flip">
	        <div class="btn-group btn-group-xs js_posts-filter" data-value="all" title='{__("All")}'>
	            ...
	            <ul class="dropdown-menu" role="menu">
	                ...
	                <li><a href="#" data-title='{__("Links")}' data-value="link"><i class="fa fa-link fa-fw"></i> {__("Links")}</a></li>
	                <li><a href="#" data-title='{__("Media")}' data-value="media"><i class="fa fa-video fa-fw"></i> {__("Media")}</a></li>
	                <li><a href="#" data-title='{__("Photos")}' data-value="photos"><i class="fa fa-file-image fa-fw"></i> {__("Photos")}</a></li>
	                ...
	                <li><a href="#" data-title='{__("Files")}' data-value="file"><i class="fa fa-file-alt fa-fw"></i> {__("Files")}</a></li>
	                <li><a href="#" data-title='{__("Polls")}' data-value="poll"><i class="fa fa-chart-pie fa-fw"></i> {__("Polls")}</a></li>
	                <li><a href="#" data-title='{__("Products")}' data-value="product"><i class="fa fa-tag fa-fw"></i> {__("Products")}</a></li>
	                <li><a href="#" data-title='{__("Articles")}' data-value="article"><i class="fa fa-file-alt fa-fw"></i> {__("Articles")}</a></li>

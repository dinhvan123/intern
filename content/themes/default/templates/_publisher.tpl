    ...
    <ul class="publisher-tabs clearfix">
        <li>
            <span class="active js_publisher-tab" data-tab="post">
                <i class="fa fa-pencil-alt fa-fw"></i> <span class="hidden-xs">{__("Write")}</span> {__("Post")}
            </span>
        </li>
        {if $system['photos_enabled']}
            <li>
                <span class="js_publisher-tab" data-tab="album">
                    <i class="fa fa-images fa-fw"></i> <span class="hidden-xs">{__("Create")}</span> {__("Album")}
                </span>
            </li>
        {/if}
        {if $system['polls_enabled'] || ($system['market_enabled'] && $_handle != "group" && $_handle != "event") || ($system['blogs_enabled'] && $_handle != "page" && $_handle != "group" && $_handle != "event") || $system['videos_enabled'] || $system['audio_enabled'] || $system['file_enabled']}
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                {if $system['blogs_enabled'] && $_handle != "page" && $_handle != "group" && $_handle != "event"}
                    <li>
                        <a href="{$system['system_url']}/blogs/new{if $_handle == 'page'}?page_id={$_id}{/if}">
                ...
                {if $system['videos_enabled']}
                    <li>
                        <span class="publisher-tools-attach js_publisher-tab" data-tab="video">
                            <i class="fa fa-video fa-fw js_x-uploader" data-handle="publisher" data-type="video"></i> {__("Add Video")}
                        </span>
                    </li>
                {/if}

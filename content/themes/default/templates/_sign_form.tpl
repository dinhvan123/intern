            ...
            <form class="js_ajax-forms" data-url="core/signup.php">
                ...
                <div class="js_hidden-section x-hidden">
                    ...
                    <div class="checkbox checkbox-primary">
                        ...
                        <label for="privacy_agree">{__("By creating your account, you agree to our")} <a href="{$system['system_url']}/static/terms" target="_blank">{__("Terms")}</a> & <a href="{$system['system_url']}/static/privacy" target="_blank">{__("Privacy Policy")}</a></label>
                    </div>
                </div>

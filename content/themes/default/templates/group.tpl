            ...
            <div class="profile-header">
                ...
                <div class="profile-cover-wrapper">
                    {if $group['group_cover_id']}
                        <img class="js_lightbox" style="top: {$group['group_cover_position']}" data-init-position="{$group['group_cover_position']}" data-id="{$group['group_cover_id']}" data-image="{$system['system_uploads']}/{$group['group_cover']}" data-context="album" src="{$system['system_uploads']}/{$group['group_cover']}" alt="{$group['group_title']}">
                    {/if}
                ...
                <div class="profile-avatar-wrapper">
                    <img {if !$group['group_picture_default']} class="js_lightbox" data-id="{$group['group_picture_id']}" data-image="{$group['group_picture_full']}" data-context="album" {/if} src="{$group['group_picture']}" alt="{$group['group_title']}">
                            ...
                            <div class="panel-body with-nav">
                                <ul class="side-nav">
                                    ...
                                    <li {if $sub_view == "members"}class="active"{/if}>
                                        <a href="{$system['system_url']}/groups/{$group['group_name']}/settings/members"><i class="fa fa-users fa-fw fa-lg pr10"></i> {__("Members")}</a>
                                    </li>
                        ...
                        <div class="panel panel-default">
                            ...
                            {elseif $sub_view == "members"}
                                ...
                                <div class="panel-body">
                                    <!-- admins -->
                                    <div>
                                        <div class="panel-title">{__("Admins")} <span class="text-x-muted">({$group['group_admins_count']})</span></div>
                                    ...
                                    <!-- members -->
                                    <div class="mt20">
                                        <div class="panel-title">{__("All Members")} <span class="text-x-muted">({$group['group_members']})</span></div>
                                        {if $group['group_members'] > 0}
                                            <ul class="row">
                                                {foreach $group['members'] as $_user}
                                                {include file='__feeds_user.tpl' _connection=$_user["connection"]}

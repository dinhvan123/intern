...
/* Smarty version 3.1.32, created on 2020-11-15 11:15:29
  from 'D:\Download\xampp\htdocs\testmxh\content\themes\default\templates\__feeds_post_photo.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5fb10dd1df9de4_98582305',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5fbb0e575fb1618de49e3fcc589a778a6e16cb0d' => 
    array (
      0 => 'D:\\Download\\xampp\\htdocs\\testmxh\\content\\themes\\default\\templates\\__feeds_post_photo.tpl',
      1 => 1538429914,
      2 => 'file',
    ),
  ),
...
function content_5fb10dd1df9de4_98582305 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- post body -->
 ...
 <?php echo __("Shares");?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['user']->value->_logged_in) {?>
        <div class="post-actions clearfix">
            <!-- like -->
            <span class="action-btn <?php if ($_smarty_tpl->tpl_vars['photo']->value['i_like']) {?>text-active js_unlike-<?php if ($_smarty_tpl->tpl_vars['photo']->value['is_single']) {?>post<?php } else { ?>photo<?php }
} else { ?>js_like-<?php if ($_smarty_tpl->tpl_vars['photo']->value['is_single']) {?>post<?php } else { ?>photo<?php }
}?>">
                <i class="fa fa-thumbs-up"></i> <span><?php echo __("Like");?>
</span>
            </span>
            <!-- like -->
            ...
            <?php if ($_smarty_tpl->tpl_vars['post']->value['privacy'] == "public") {?>
                <span class="action-btn <?php if ($_smarty_tpl->tpl_vars['system']->value['social_share_enabled']) {?>js_share-toggle<?php } else { ?>js_share<?php }?>" data-id="<?php echo $_smarty_tpl->tpl_vars['post']->value['post_id'];?>
">
